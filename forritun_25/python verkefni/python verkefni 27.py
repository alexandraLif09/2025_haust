...
while aftur:        #Keyrir á meðan breytan aftur er True
    ...
    while running:
        ...
        if spilari2 == 'j':     #Ef spilari 2 er j þá heldur hún áfram
            tala2 = randint(1,13)   #Velur tölu frá 1 - 13
            samtals2 = samtals2 + tala2     #Leggu töluna við samtals stig
            print ("Spilari 2 fékk: ",tala2)    #Prentar út hvaða tölu spilari 2 fékk

            print ("Spilari 1 er nú kominn með ",samtals1)     #prentar út hvaða tölu spilari 1 er með samtals
            print ("Spilari 2 er nú kominn með ",samtals2)     #prentar út hvaða tölu spilari 2 er með samtal
